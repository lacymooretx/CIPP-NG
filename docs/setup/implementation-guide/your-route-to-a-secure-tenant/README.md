...
Follow this implementation guide to bring your tenants to a security level recommended by CIPP. Currently this security level aligns with multiple recognised standards such as CIS, Essentials 8, and Entra ID SCA. This guide is reevaluated every three months to keep up with the latest changes in M365.
