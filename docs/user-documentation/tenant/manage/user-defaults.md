...
| Shared Mailbox Permissions                                   | The access level granted on those mailboxes: `Full Access`, `Send As`, and `Send on Behalf`. Several can be selected together. Defaults to `Full Access`.                                                                                                                   |
