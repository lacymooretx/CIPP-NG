...
We recommend that all remaining users get invited via [cipp-roles](../../user-documentation/cipp/advanced/authentication/cipp-roles/ "mention").
{% endhint %}
...
You can assign these roles to users using the [cipp-roles](../../user-documentation/cipp/advanced/authentication/cipp-roles/ "mention") page.
